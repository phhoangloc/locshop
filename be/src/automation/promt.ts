export const prompt = (type: string, body: { title: string, link: string }, html?: string, imgs?: string[]) => {
    switch (type) {
        case "blog":
            ...
            Hãy viêt một bài blog hấp dẫn, sinh động về địa điểm hoặc sự kiện dưới đây khoảng 1500 chữ bằng tiếng nhật.
  ...
  `;
        ...
        case "image":
            ...
            Bước 3:  lọc những và loại bỏ những url trùng nhau. không lấy url có tên miền "https://baomoi-photo-fbcrawler.bmcdn.me/". kiểm tra hình ảnh có Intrinsic size nhỏ hơn 500px * 200px thì không lấy. lấy khoảng 10 url hình ảnh.
